...
#
# # CDM20
# CDM_TYPE_EVENT='com.bbn.tc.schema.avro.cdm20.Event'
# CDM_UUID='com.bbn.tc.schema.avro.cdm20.UUID'
#
# CDM_TYPE_FILE = 'com.bbn.tc.schema.avro.cdm20.FileObject'
# CDM_TYPE_SOCK = 'com.bbn.tc.schema.avro.cdm20.NetFlowObject'
# CDM_TYPE_SUBJECT = 'com.bbn.tc.schema.avro.cdm20.Subject'
# CDM_TYPE_SRCSINK = 'com.bbn.tc.schema.avro.cdm20.SrcSinkObject'
# CDM_TYPE_PIPE = 'com.bbn.tc.schema.avro.cdm20.UnnamedPipeObject'
# CDM_TYPE_PRINCIPAL = 'com.bbn.tc.schema.avro.cdm20.Principal'
# CDM_TYPE_TAG = 'com.bbn.tc.schema.avro.cdm20.ProvenanceTagNode'
# CDM_TYPE_STARTMARKER = 'com.bbn.tc.schema.avro.cdm20.StartMarker'
# CDM_TYPE_TIMEMARKER = 'com.bbn.tc.schema.avro.cdm20.TimeMarker'
# CDM_TYPE_HOST = 'com.bbn.tc.schema.avro.cdm20.Host'
# CDM_TYPE_KEY = 'com.bbn.tc.schema.avro.cdm20.RegistryKeyObject'
# CDM_TYPE_MEMORY = 'com.bbn.tc.schema.avro.cdm20.MemoryObject'
# CDM_TYPE_ENDMARKER = 'com.bbn.tc.schema.avro.cdm20.EndMarker'
# CDM_TYPE_UNITDEPENDENCY = 'com.bbn.tc.schema.avro.cdm20.UnitDependency'
